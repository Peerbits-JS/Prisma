...
namespace F3M.Oticas.Domain.Entities
{
    public partial class TbParametrosEmpresa
    {
        public TbParametrosEmpresa()
        {
            ...
            TbParametrosEmpresaCae = new HashSet<TbParametrosEmpresaCae>();
        }
        ...
        public long? IdpaisesDesc { get; set; }

        public TbSistemaIdiomas IdidiomaBaseNavigation { get; set; }
        public TbMoedas IdmoedaDefeitoNavigation { get; set; }
        public TbSistemaSiglasPaises IdpaisNavigation { get; set; }
        public Country IdpaisesDescNavigation { get; set; }
        public ICollection<TbParametrosContexto> TbParametrosContexto { get; set; }
        public ICollection<TbParametrosEmpresaCae> TbParametrosEmpresaCae { get; set; }
    }
}

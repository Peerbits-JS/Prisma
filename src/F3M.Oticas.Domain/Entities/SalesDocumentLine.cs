...
{
    public partial class SaleDocumentLine : DocumentLineMain
    {
        public SaleDocumentLine()
        {
            InverseIdlinhaDocumentoCompraInicialNavigation = new HashSet<SaleDocumentLine>();
        ...
        public double? ValorUnitarioEntidade1 { get; set; }
        public double? ValorUnitarioEntidade2 { get; set; }
        public double? ValorEntidade1 { get; set; }
        public double? ValorEntidade2 { get; set; }
        public double? TotalFinal { get; set; }
        public long? Idservico { get; set; }
        public long? IdtipoServico { get; set; }
        public long? IdtipoOlho { get; set; }
        public string TipoDistancia { get; set; }
        public string TipoOlho { get; set; }
        ...
        public long? IdadiantamentoOrigem { get; set; }
        ...
        public TbCampanhas IdcampanhaNavigation { get; set; }
        ...
        public SaleDocumentLine IdlinhaDocumentoCompraInicialNavigation { get; set; }
        ...
        public ICollection<SaleDocumentLine> InverseIdlinhaDocumentoCompraInicialNavigation { get; set; }
        public ICollection<PurchaseDocumentLine> TbDocumentosComprasLinhas { get; set; }

        public override DocumentBase GetDocumentBase() => IddocumentoVendaNavigation;

        public override double GetDiscount() => EffectiveDiscountValueWithoutVat ?? 0;

        public override double GetCostOfGoods()
        {
            var pcmatualMoedaRef = PcmatualMoedaRef ?? 0;
            var quantidade = Quantidade ?? 0;

            return pcmatualMoedaRef * quantidade;
        }

        public override double GetPurchaseCostOfGoods() => 0;
    }
}

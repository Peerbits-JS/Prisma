...
{
    public partial class StockDocumentLine : DocumentLineMain
    {
        public StockDocumentLine()
        {
            InverseIdlinhaDocumentoStockInicialNavigation = new HashSet<StockDocumentLine>();
            InverseIdlinhaDocumentoStockNavigation = new HashSet<StockDocumentLine>();
            TbDocumentosComprasLinhasIdlinhaDocumentoStockInicialNavigation = new HashSet<PurchaseDocumentLine>();
            TbDocumentosComprasLinhasIdlinhaDocumentoStockNavigation = new HashSet<PurchaseDocumentLine>();
            TbDocumentosVendasLinhas = new HashSet<SaleDocumentLine>();
        }

        public long IddocumentoStock { get; set; }
        ...
        public StockDocument IddocumentoStockNavigation { get; set; }
        ...
        public ICollection<StockDocumentLine> InverseIdlinhaDocumentoStockInicialNavigation { get; set; }
        public ICollection<StockDocumentLine> InverseIdlinhaDocumentoStockNavigation { get; set; }
        public ICollection<PurchaseDocumentLine> TbDocumentosComprasLinhasIdlinhaDocumentoStockInicialNavigation { get; set; }
        public ICollection<PurchaseDocumentLine> TbDocumentosComprasLinhasIdlinhaDocumentoStockNavigation { get; set; }
        public ICollection<SaleDocumentLine> TbDocumentosVendasLinhas { get; set; }

        public override DocumentBase GetDocumentBase() => IddocumentoStockNavigation;

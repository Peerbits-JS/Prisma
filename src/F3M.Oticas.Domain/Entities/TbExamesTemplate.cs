...
{
    public partial class TbExamesTemplate
    {
        public TbExamesTemplate()
        {
            InverseIdpaiNavigation = new HashSet<TbExamesTemplate>();
        }
        ...
        public TbExamesTemplate IdpaiNavigation { get; set; }
        public TbTemplates IdtemplateNavigation { get; set; }
        public ICollection<TbExamesTemplate> InverseIdpaiNavigation { get; set; }
    }
}

/* ACT BD EMPRESA VERSAO 19*/
EXEC('ALTER TABLE tbDocumentosComprasLinhas ADD QtdStockReserva float NULL')
EXEC('ALTER TABLE tbDocumentosComprasLinhas ADD QtdStockReserva2Uni float NULL')
EXEC('ALTER TABLE tbDocumentosComprasLinhasDimensoes ADD QtdStockReserva float NULL')
EXEC('ALTER TABLE tbDocumentosComprasLinhasDimensoes ADD QtdStockReserva2Uni float NULL')

EXEC('ALTER TABLE tbDocumentosStockLinhas ADD QtdStockReserva float NULL')
EXEC('ALTER TABLE tbDocumentosStockLinhas ADD QtdStockReserva2Uni float NULL')
EXEC('ALTER TABLE tbDocumentosStockLinhasDimensoes ADD QtdStockReserva float NULL')
EXEC('ALTER TABLE tbDocumentosStockLinhasDimensoes ADD QtdStockReserva2Uni float NULL')

EXEC('ALTER TABLE tbDocumentosVendasLinhas ADD QtdStockReserva float NULL')
EXEC('ALTER TABLE tbDocumentosVendasLinhas ADD QtdStockReserva2Uni float NULL')

exec('ALTER TABLE tbTiposDocumento ADD IDTipoDocCusto bigint null')
exec('ALTER TABLE [dbo].[tbTiposDocumento]  WITH CHECK ADD  CONSTRAINT [FK_tbTiposDocumento_tbTiposDocumento3] FOREIGN KEY([IDTipoDocCusto]) REFERENCES [dbo].[tbTiposDocumento] ([ID])')

EXEC('DROP PROCEDURE [dbo].[sp_AtualizaQtdRequisitada]')
...
(case when d.CodigoTipoEstado=''''ANL'''' then 0 else (isnull(d.TotalClienteMoedaDocumento,0)-isnull(d.valorpago,0)) end) as ValorPendente, s.Descricao as DescricaoEstado, e1.Descricao as DescricaoEntidade1, e2.Descricao as DescricaoEntidade2, TD.IDSistemaTiposDocumento, cast(1 as bit) as FazTestesRptStkMinMax, d.CodigoTipoEstado as CodigoTipoEstado, TD.Adiantamento as Adiantamento

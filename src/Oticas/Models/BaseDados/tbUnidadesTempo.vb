...
Partial Public Class tbUnidadesTempo
    ...
    Public Property FatorConversaoSeg As Double
    Public Property IDFormato As Long

    Public Overridable Property tbSistemaFormatoUnidadeTempo As tbSistemaFormatoUnidadeTempo

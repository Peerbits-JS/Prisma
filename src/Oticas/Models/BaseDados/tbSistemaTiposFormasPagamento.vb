...
Partial Public Class tbSistemaTiposFormasPagamento
    ...
    Public Overridable Property tbFormasPagamento As ICollection(Of tbFormasPagamento) = New HashSet(Of tbFormasPagamento)

...
Partial Public Class tbPaises
    Public Property ID As Long
    Public Property Descricao As String
    Public Property VariavelContabilidade As String
    Public Property IDSigla As Long
    ...
    Public Overridable Property tbDocumentosVendas4 As ICollection(Of tbDocumentosVendas) = New HashSet(Of tbDocumentosVendas)

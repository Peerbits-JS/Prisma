...
Partial Public Class tbEstados
    ...
    Public Property IDEntidadeEstado As Long
    Public Property IDTipoEstado As Long
    Public Property Predefinido As Boolean
    Public Property EstadoInicial As Boolean
    ...
    Public Overridable Property tbSistemaEntidadesEstados As tbSistemaEntidadesEstados
    Public Overridable Property tbSistemaTiposEstados As tbSistemaTiposEstados

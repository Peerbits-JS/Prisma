...
Partial Public Class tbSistemaTiposExtensoesFicheiros
    Public Property ID As Long
    Public Property Codigo As String
    Public Property Descricao As String
    Public Property ExtensoesPermitidas As String
    ...
    Public Overridable Property tbSistemaTiposAnexos As ICollection(Of tbSistemaTiposAnexos) = New HashSet(Of tbSistemaTiposAnexos)

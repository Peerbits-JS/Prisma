...
Partial Public Class tbParametrosLojaLinhasValores
    Public Property ID As Long
    Public Property IDParametroLojaLinha As Long
    ...
    Public Overridable Property tbParametrosLojaLinhas As tbParametrosLojaLinhas

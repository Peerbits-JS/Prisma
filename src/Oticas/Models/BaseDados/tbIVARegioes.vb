...
Partial Public Class tbIVARegioes
    Public Property ID As Long
    Public Property IDIva As Long
    Public Property IDRegiao As Long
    Public Property IDIvaRegiao As Nullable(Of Long)
    ...
    Public Overridable Property tbIVA1 As tbIVA

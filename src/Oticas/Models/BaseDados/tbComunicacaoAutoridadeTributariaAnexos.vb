...
Partial Public Class tbComunicacaoAutoridadeTributariaAnexos
    ...
    Public Overridable Property tbComunicacaoAutoridadeTributaria As tbComunicacaoAutoridadeTributaria

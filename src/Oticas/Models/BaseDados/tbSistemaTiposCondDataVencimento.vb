...
Partial Public Class tbSistemaTiposCondDataVencimento
    ...
    Public Overridable Property tbCondicoesPagamento As ICollection(Of tbCondicoesPagamento) = New HashSet(Of tbCondicoesPagamento)

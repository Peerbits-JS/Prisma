...
Partial Public Class tbTextosBase
    ...
    Public Property IDTiposTextoBase As Long

    Public Overridable Property tbSistemaTiposTextoBase As tbSistemaTiposTextoBase

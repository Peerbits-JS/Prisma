...
Partial Public Class tbCondicoesPagamento
    Public Property ID As Long
    Public Property IDTipoCondDataVencimento As Nullable(Of Long)
    Public Property Codigo As String
    Public Property Descricao As String
    Public Property DescontosIncluiIva As Boolean
    Public Property ValorCondicao As Nullable(Of Integer)
    ...
    Public Overridable Property tbSistemaTiposCondDataVencimento As tbSistemaTiposCondDataVencimento

...
Namespace Areas.Exames.Controllers
    Public Class ExamesAnexosController
        Inherits AnexosController(Of BD.Dinamica.Aplicacao, tbExamesAnexos)

#Region "CONSTRUTORES"
        Sub New()
            MyBase.New(New RepositorioExamesAnexos)
        End Sub
#End Region
...
#Region "ACOES DEFAULT POST CRUD"
        ...
        Public Overrides Function Adiciona(<DataSourceRequest> request As DataSourceRequest, <Bind> ByVal modelo As F3M.Anexos, inObjFiltro As ClsF3MFiltro) As JsonResult
            ...
            inObjFiltro.CamposAPreencher.Add("IDExame", modelo.IDChaveEstrangeira)

...
@Code
    ...
    With Model
        .URLLadoEsquerdo = "~/Areas/Agendamento/Views/Agendamento/BarraEsq.vbhtml" 'obrigatório, define conteúdo da barra esq'
        .URLLadoDireito = "" 'obrigatório, define conteúdo da barra dir'
        .URLAreaGeral = "~/Areas/Agendamento/Views/Agendamento/AreaGeral.vbhtml" 'obrigatório, define conteúdo da área geral'
        ...
        .ESobrepostaEsq = False 'obrigatório, faz com que as barras se sobreponham à area geral/central'
        ...
        .URLLadoEsquerdoFechado = "~/Areas/Agendamento/Views/Agendamento/BarraEsqFechada.vbhtml" 'obrigatório, coloca conteúdo na barra esquerda quando esta está fechada'
        ...
        .LateralEsqSegundoTxtResumo = "Especialidades "  'nao obrigatorio'
        .LateralEsqSegundoBadge = "2"  'nao obrigatorio'
        .LateralEsqTerceiroTxtResumo = "Médicos "  'nao obrigatorio'
...
@Scripts.Render("~/bundles/f3m/jsAgendamento")
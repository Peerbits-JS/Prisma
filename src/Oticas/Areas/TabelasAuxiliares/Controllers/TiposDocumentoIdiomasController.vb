...
Namespace Areas.TabelasAuxiliares.Controllers
    Public Class TiposDocumentoIdiomasController
        Inherits ClsF3MController(Of BD.Dinamica.Aplicacao, tbTiposDocumentoIdioma, TiposDocumentoIdiomas)

#Region "REPOSITORIO"
        Sub New()
            MyBase.New(New RepositorioTiposDocumentoIdiomas)
        End Sub
#End Region
...
#Region "ACOES DEFAULT POST CRUD"
        ...
        <HttpPost>
        Function Adiciona(<DataSourceRequest> request As DataSourceRequest, <Bind> ByVal modelo As TiposDocumentoIdiomas, filtro As ClsF3MFiltro) As JsonResult
        ...
        <HttpPost>
        Function Edita(<DataSourceRequest> request As DataSourceRequest, <Bind> ByVal modelo As TiposDocumentoIdiomas, filtro As ClsF3MFiltro) As JsonResult
        ...
        <HttpPost>
        Function Remove(<DataSourceRequest> request As DataSourceRequest, <Bind> ByVal modelo As TiposDocumentoIdiomas, filtro As ClsF3MFiltro) As JsonResult

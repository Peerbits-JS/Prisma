        ...
        <div class="FormularioAjudaScroll">
            <div class="container-fluid f3m-caixa-multiselect clsF3MCatalogoLentes">
                <div class="mb-2 mt-3">
                    ...
                    <span id="btn-matriz-precos" class="btn main-btn btn-sm float-right disabled hidden">
                        @Traducao.EstruturaArtigos.MatrizPrecos
                    </span>
                </div>
...
@*TODO*@
<style>
    .f3m-caixa-multiselect.em-tab .caixa-listview-meia {

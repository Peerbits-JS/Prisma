...
@Code
    ...
    listaCol.Add(New ClsF3MCampo With {.Id = "EContactologia", .LarguraColuna = 100})

    Dim gf As New ClsMvcKendoGrid With {.Tipo = New Especialidades().GetType, .Campos = listaCol}

    gf.GrelhaHTML = Html.F3M().Grelha(Of Especialidades)(gf).ToHtmlString()
End Code

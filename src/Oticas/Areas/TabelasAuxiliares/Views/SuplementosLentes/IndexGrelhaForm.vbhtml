...
@Code
    Dim grid As Fluent.GridBuilder(Of SuplementosLentes)
    ...
    If Not Model.OrigemF4.IsEmpty Then
        ...
        End If
        grid = Html.F3M().Grelha(Of SuplementosLentes)(Model)

    Else
        grid = Html.F3M().GrelhaFormulario(Of SuplementosLentes)(Model)
    End If

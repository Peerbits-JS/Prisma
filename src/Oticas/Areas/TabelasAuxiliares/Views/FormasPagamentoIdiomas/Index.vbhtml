...
@*@Scripts.Render("~/bundles/f3m/jsFormularioFormasPagamento")*@
...
@Code
    ...
    Dim gf As New ClsMvcKendoGrid With {
        .Tipo = New FormasPagamentoIdiomas().GetType,
        .FuncaoJavascriptEnviaParams = "FormasPagamentoEnviaParametros",
        .FuncaoJavascriptGridEdit = "FormasPagamentoEditaGrelha",
        .Altura = 350,
    ...
    gf.GrelhaHTML = Html.F3M().GrelhaLinhas(Of FormasPagamentoIdiomas)(gf).ToHtmlString()

    If bool Then
    @<script>
        GrelhaLinhasInit('@gf.Id', { '@CamposGenericos.ID': '@CamposGenericos.IDFormaPagamento' }, resources.Idioma);
    </script>
End If

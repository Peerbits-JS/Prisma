...
@ModelType SegmentosMercado

@Html.Partial("~/F3M/Areas/TabelasAuxiliaresComum/Views/SegmentosMercado/Detalhe.vbhtml", Model)
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="@(ClassesCSS.XS12)">
                    ...
                    @Html.Partial("~/Areas/TabelasAuxiliares/Views/SegmentosMercadoIdiomas/Index.vbhtml")
                </div>
            </div>
        </div>

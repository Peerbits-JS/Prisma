...
@Code
    ...
    listaCol.Add(New ClsF3MCampo With {.Id = CamposGenericos.Fechada,
        .LarguraColuna = 300})

    Dim gf As New ClsMvcKendoGrid With {
        .Tipo = New Distritos().GetType,
        .Campos = listaCol}
    
    gf.GrelhaHTML = Html.F3M().Grelha(Of Seriesnumeracao)(gf).ToHtmlString()
End Code

...
@Code
    ...
    listaCol.Add(New ClsF3MCampo With {.Id = "IDCultura",
        .TipoEditor = Mvc.Componentes.F3MLookup,
        .Controlador = "./../Sistema/SistemaIdiomas",
        .CampoTexto = "Codigo",
        .LarguraColuna = 300})

    Dim gf As New ClsMvcKendoGrid With {
        .Tipo = New Idiomas().GetType,
        .Campos = listaCol}

   
    gf.GrelhaHTML = Html.F3M().Grelha(Of Oticas.Idiomas)(gf).ToHtmlString()
End Code

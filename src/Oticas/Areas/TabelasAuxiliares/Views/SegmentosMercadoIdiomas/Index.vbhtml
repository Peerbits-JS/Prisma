...
@Scripts.Render("~/bundles/f3m/jsFormularioSegmentosMercado")
@Code
    ...
    listaCol.Add(New ClsF3MCampo With {.Id = "IDIdioma",
        ...
        .OpcaoMenuDescAbrev = Menus.SegmentosMercado,
        .LarguraColuna = 300})
    ...
    Dim gf As New ClsMvcKendoGrid With {
        .Tipo = New SegmentosMercadoIdiomas().GetType,
        .FuncaoJavascriptEnviaParams = "SegmentosMercadoEnviaParametros",
        .FuncaoJavascriptGridEdit = "SegmentosMercadoEditaGrelha",
        .Altura = 350,
    ...
    gf.GrelhaHTML = Html.F3M().GrelhaLinhas(Of SegmentosMercadoIdiomas)(gf).ToHtmlString()

    If bool Then
        @<script>
            GrelhaLinhasInit('@gf.Id', { '@CamposGenericos.ID': '@CamposGenericos.IDSegmentoMercado' }, resources.Idioma);
        </script>
    End If

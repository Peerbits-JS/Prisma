...
@Code
    ...
    @Scripts.Render("~/bundles/f3m/jsTabelasAuxiliaresComposicoes")
    ...
    Dim gf As New ClsMvcKendoGrid With {
        .Tipo = New Composicoes().GetType,
        .FuncaoJavascriptGridEdit = "ComposicoesEditaGrelha",
        .Campos = listaCol}

    gf.GrelhaHTML = Html.F3M().Grelha(Of Composicoes)(gf).ToHtmlString()
End Code

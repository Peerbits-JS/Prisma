...
Namespace Areas.Documentos.Controllers
    Public Class DocumentosStockAnexosController
        Inherits AnexosController(Of Oticas.BD.Dinamica.Aplicacao, tbDocumentosStockAnexos)

#Region "CONSTRUTORES"
        Sub New()
            MyBase.New(New RepositorioDocumentosStockAnexos)
        End Sub
#End Region
...
#Region "ACOES DEFAULT POST CRUD"
        ...
        Public Overrides Function Adiciona(<DataSourceRequest> request As DataSourceRequest, <Bind> ByVal modelo As F3M.Anexos,
            ...
            inObjFiltro.CamposAPreencher.Add("IDDocumentoStock", modelo.IDChaveEstrangeira)

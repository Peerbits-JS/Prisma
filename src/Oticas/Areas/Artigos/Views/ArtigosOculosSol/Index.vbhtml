...
<fieldset class="fsStyle">
    <legend class="legendStyle">@Traducao.EstruturaArtigos.OculosSol</legend>
    ...
    <div class="row form-container">
        @Code
            Html.F3M().DesenhaCampo(New ClsF3MCampo With {.Id = "CodigoCor",
                .Label = Traducao.EstruturaArtigos.CodigoCor,
                .Modelo = Model,
            ...
            Html.F3M().DesenhaCampo(New ClsF3MCampo With {.Id = "Hastes",
                .Label = Traducao.EstruturaArtigos.HastesComprimento,
                .Modelo = Model,
                .EEditavel = Not blnTemDocumentos,
                .TipoEditor = Mvc.Componentes.F3MTexto,

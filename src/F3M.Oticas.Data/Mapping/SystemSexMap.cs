...
{
    public class SystemSexMap : IEntityTypeConfiguration<SystemSex>
    {
        public void Configure(EntityTypeBuilder<SystemSex> entity)
        {
            entity.ToTable("tbSistemaSexo");

            entity.Property(e => e.Id).HasColumnName("ID").ValueGeneratedNever();

            entity.Property(e => e.Code).HasColumnName("Codigo").IsRequired().HasMaxLength(3);

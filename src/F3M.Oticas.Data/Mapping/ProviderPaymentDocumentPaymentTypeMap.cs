...
{
    public class ProviderPaymentDocumentPaymentTypeMap : IEntityTypeConfiguration<ProviderPaymentDocumentPaymentType>
    {
        public void Configure(EntityTypeBuilder<ProviderPaymentDocumentPaymentType> entity)
        {
            ...
            entity.HasOne(d => d.ProviderPaymentDocument)
                .WithMany(p => p.ProviderPaymentDocumentPaymentType)
